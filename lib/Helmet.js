...
var generateTagsAsString = function generateTagsAsString(type, tags) {
    var stringifiedMarkup = tags.map(function (tag) {
        ...
        var isSelfClosing = [_HelmetConstantsJs.TAG_NAMES.NOSCRIPT, _HelmetConstantsJs.TAG_NAMES.SCRIPT, _HelmetConstantsJs.TAG_NAMES.STYLE].indexOf(type) === -1;
...
var mapStateOnServer = function mapStateOnServer(_ref) {
    ...
    var noscriptTags = _ref.noscriptTags;
    ...
    return {
        ...
        noscript: getMethodsForTag(_HelmetConstantsJs.TAG_NAMES.NOSCRIPT, noscriptTags),
...
var reducePropsToState = function reducePropsToState(propsList) {
    return {
        ...
        noscriptTags: getTagsFromPropsList(_HelmetConstantsJs.TAG_NAMES.NOSCRIPT, [_HelmetConstantsJs.TAG_PROPERTIES.INNER_HTML], propsList),
...
var handleClientStateChange = function handleClientStateChange(newState) {
    ...
    var noscriptTags = newState.noscriptTags;
    ...
    var tagUpdates = {
        ...
        noscriptTags: updateTags(_HelmetConstantsJs.TAG_NAMES.NOSCRIPT, noscriptTags),
